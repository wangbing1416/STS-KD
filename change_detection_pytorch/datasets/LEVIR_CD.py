...
class LEVIR_CD_Dataset(CustomDataset):
    ...
    def get_default_transform(self):
        ...
        default_transform = A.Compose([
            A.RandomCrop(self.size, self.size),  # random crop
            # A.ShiftScaleRotate(),
            A.Normalize(),
            ToTensorV2()
    ...
    def __getitem__(self, idx):
        ...
        if not self.ann_dir:  # inference stage
            ann = None
            ...
            transformed_data = self.transform(image=img1, image_2=img2, mask=ann)  # refer to get_default_transform()
